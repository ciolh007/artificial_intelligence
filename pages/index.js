...
export default function Home() {
  return (
    <div>
      <h1 className="title">Jacky Baltes - Artificial Intelligence</h1>
      ...
      <p>        
      <iframe src="https://drive.google.com/embeddedfolderview?id=16liPSKRT_iHThoQIx3rvcY8nU7yN_VTb"></iframe>
      </p>
      </>
